...
class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    final String LOGTAG = "CameraPreview";
    ...
    // JNI functions
    public native int getCameraFrame(byte[] data);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        // [liuchang start] Add debug log
        if (-1 == ret) {
            Log.d(LOGTAG, "prepareCameraWithBase return error");
            Log.d(LOGTAG, "cameraExists = " + cameraExists);
        }
